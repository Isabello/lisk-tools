...
read -r -p "What port do they use? (default: 587): " response
...
read -r -p "What is your email servers encryption? (default: tlsv1): " response
...
read -r -p "What user do you run lisk as? (ex: lisk ): " response
sed -i "s|lisk_user|$response|g" checknodeprocess
